...
def live_record(sub_path, url, film_time, platform, short_id):
    ...
    cur.execute("INSERT INTO luzhi.subprocess_status (id,status,film_up,logic_delete) values (%s,%s,%s,%s)",
                (film_id, '正在录制', sub_path, 0))
